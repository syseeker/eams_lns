...
#    cfg_data   -->  number of test cases in line[0], follow by a list of test cases to run 
    ...
    for i in range(1, runCount+1):        
        ...
        milp_solver = Solver_MILP(eams, eams.fn, casecfgid[1], MIP_TIMELIMIT_SEC, MIP_LOG_CB)
        milp_solver.solveMILP(MIP_LOG_CB, MIP_TIMELIMIT_SEC, 1)
        milp_solver.logXW(casecfgid[1])
        ...
        milp_solver.solveMILPWithInitialSchedule(casecfgid[1] + "_XW", MIP_LOG_CB, MIP_TIMELIMIT_SEC, 0)
        milp_solver.logSchedulingResults()    
        milp_solver.logHVACResults()
        milp_solver.logSchedules(casecfgid[1]+"_FULLMODELGIVENX")
        milp_solver.logTemperatures(casecfgid[1]+"_FULLMODELGIVENX")
